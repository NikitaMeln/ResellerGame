...
public class RoomController {
    ...
    public void join(JoinRoomRequest req, Principal principal) {
        ...
        ws.convertAndSend(
                ...
                Map.of("roomId", updatedRoom.getId(), "roomState", gameRoomMapper.toDto(updatedRoom))
        );
    }

    @MessageMapping("/game.start")       // /app/game.start
    ...
    public void buyTuning(BuyTuningRequest req) {
        ...
        roomService.processBuyTuning(room, player, tuning);
